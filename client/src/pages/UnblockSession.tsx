...
import { ArrowRight, Check, Clock, Code2, MessageSquare, ShieldCheck, Zap } from "lucide-react";
        ...
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/">
            <a className="flex items-center gap-3 group">
              <img src="/favicon.png" alt="First Radicle Logo" className="w-8 h-8 group-hover:rotate-12 transition-transform duration-500" />
              <span className="font-serif text-xl font-bold tracking-tight text-primary">First Radicle</span>
            </a>
          </Link>
          <div className="hidden md:flex items-center gap-8">
            <Link href="/#process"><a className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors">Process</a></Link>
            <Link href="/#work"><a className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors">Work</a></Link>
            <Link href="/#blog"><a className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors">From the Roots</a></Link>
            <Link href="/unblock"><a className="text-sm font-medium text-primary">Unblock Session</a></Link>
          </div>
          <OrganicButton className="hidden md:inline-flex">
            Book Call
          </OrganicButton>
        </div>
      </nav>
        ...
        <footer className="bg-primary text-primary-foreground py-20 border-t border-white/10">
          <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-8">
              <div className="flex items-center gap-3">
                <img src="/favicon.png" alt="First Radicle Logo" className="w-8 h-8 brightness-0 invert" />
                <span className="font-serif text-xl font-bold tracking-tight">First Radicle</span>
              </div>
              <div className="text-primary-foreground/60 text-sm">
                © 2024 First Radicle. All rights reserved.
              </div>
            </div>
          </div>
        </footer>
