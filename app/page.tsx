    ...
    <>
      ...
      <Section className="pt-20 pb-32 relative">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="relative z-10">
            ...
            <Subheadline>
              We turn struggling no-code projects into scalable,
      ...
      <div className="border-y border-border bg-white/50 py-12">
        <div className="container">
          <p className="font-sans text-center text-sm font-medium mb-8 text-muted-foreground tracking-wide">
            TRUSTED BY FOUNDERS MIGRATING FROM
          </p>
          <div className="flex flex-wrap justify-center gap-8 md:gap-12 lg:gap-16 opacity-40 grayscale hover:grayscale-0 transition-all duration-500">
            <span className="text-xl md:text-2xl font-bold font-serif text-primary max-w-[calc(25%-1.5rem)] md:max-w-[calc(20%-1.5rem)] lg:max-w-[calc(16.666%-1rem)] text-center">
              Bubble
            </span>
            <span className="text-xl md:text-2xl font-bold font-serif text-primary max-w-[calc(25%-1.5rem)] md:max-w-[calc(20%-1.5rem)] lg:max-w-[calc(16.666%-1rem)] text-center">
              Webflow
        ...
        <div className="grid md:grid-cols-2 gap-20 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <Headline className="text-foreground">
              Your No-Code App is a{" "}
              <span className="text-destructive font-serif italic">
                Tangled Mess.
              </span>
            </Headline>
            <div className="space-y-8 font-sans text-lg text-muted-foreground">
              <div className="flex gap-6 items-start">
                <div className="bg-destructive/10 text-destructive w-10 h-10 rounded-full flex items-center justify-center font-bold flex-shrink-0 mt-1">
                  !
                </div>
                <p>
              ...
              <div className="flex gap-6 items-start">
                ...
                <p>
                  ...
                  VCs want IP, not a rented house on someone else's land. You
                  need code to raise capital.
                </p>
              </div>
            </div>
          </div>
      ...
      <Section id="solution" className="bg-secondary/30">
        <div className="text-center max-w-4xl mx-auto mb-20">
          <Headline>
            Real Code. Organic Scale. <br />
            No Headaches.
          </Headline>
          <Subheadline className="mx-auto">
            We bridge the gap between validation and venture scale. You get a
            battle-tested ecosystem enhanced with AI speed.
          </Subheadline>
        </div>
          ...
          <div>
            ...
            <div className="space-y-12 mt-12">
              <div className="relative pl-12 border-l-2 border-primary/20">
                ...
                <h3 className="text-2xl font-serif font-medium mb-2 text-primary">
                  The Handover
                </h3>
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="organic-card p-6 hover:bg-white transition-colors">
                ...
                <h4 className="font-serif font-bold mb-2 text-primary">
                  Clean Architecture
                </h4>
      ...
      <Section className="bg-primary text-primary-foreground">
        <Headline className="text-center text-primary-foreground mb-16">
          Founder Stories
        </Headline>
              ...
              {[
                ...
                >
                  <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl relative border border-white/10 h-full flex flex-col">
                    <div className="text-6xl font-serif absolute top-4 left-4 opacity-20">
                      "
                    </div>
      ...
      <Section className="bg-primary/5 text-center py-32">
        ...
        <p className="text-xl md:text-2xl font-sans text-muted-foreground max-w-2xl mx-auto mb-12">
          Don't let your no-code prototype hold you back. Secure your spot for
          next month's sprint.
        </p>
