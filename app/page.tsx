      ...
      <Section className="pt-20 pb-32 relative">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="relative z-10">
            <Link href="/unblock" className="inline-flex items-center gap-2 bg-chart-2 text-primary-foreground px-5 py-2 rounded-full font-sans font-bold text-sm mb-6 hover:bg-chart-2/90 transition-all shadow-md hover:shadow-lg cursor-pointer group border border-chart-2/50">
                ...
                <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/2 pl-6">
                  <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl relative border border-white/10 h-full flex flex-col">
                    ...
                    <div className="flex items-center gap-4 mt-auto">
                      <Image src={testimonial.avatar} alt={testimonial.name} width={48} height={48} className="w-12 h-12 rounded-full object-cover border-2 border-white/20" />
                      <div>
