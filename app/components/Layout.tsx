      ...
      <nav className="py-6 sticky top-0 bg-background/80 backdrop-blur-md z-50 border-b border-border">
        <div className="container flex justify-between items-center">
          <Link href="/" className="flex items-center gap-3 cursor-pointer">
            <Image src="/images/logo.png" alt="First Radicle Logo" width={40} height={40} className="h-10 w-auto" />
          ...
          <div className="hidden lg:flex gap-8 font-sans font-medium text-sm text-muted-foreground">
            ...
            <Link href="/unblock" className="hover:text-primary transition-colors font-bold">Unblock Session</Link>
          </div>
          <Link href="/unblock">
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-2">
              <div className="flex items-center gap-3 mb-6">
                <Image src="/images/logo.png" alt="First Radicle Logo" width={32} height={32} className="h-8 w-auto brightness-0 invert" />
